      ...
      function saveDirectorInformation() {
     ...
     function getDirectorsAndPromoters() {    
          var table = $('#directorAndPromoters').DataTable({
